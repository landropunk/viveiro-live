...
export default function Seccion5Page() {
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Puedes modificar el archivo <code className="rounded bg-gray-100 px-2 py-1 text-sm dark:bg-gray-800">app/(protected)/dashboard/seccion5/page.tsx</code> para agregar el contenido que necesites.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-300">
                Para activar esta sección, ve a <strong>/admin/settings</strong> y desbloquea "Sección 5" modificando su estado <code>locked</code> en la base de datos.
              </p>
            </div>
